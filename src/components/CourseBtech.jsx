  ...
  return (
    ...
    <div className="pt-5 container text-center my-5"id="coursebtechchanged">
      <div className=" d-flex gap-2 justify-content-center">
        <a href = "coursesbtech" className="btn btnbtechcoursepage-custom " id="">
          B TECH/ AMIIE
        </a>
        ...
        {/* </a> */}
        <a href = "coursesdiploma" className="btn btndiploma-custom " id="">
        DIPLOMA/ TMIIE
        </a>
      </div>
    </div>
